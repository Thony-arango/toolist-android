    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(stringResource(R.string.login_hint_email)) },
                leadingIcon = {
                    Icon(
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(
                    onDone = {
                        ...
                        if (!uiState.isLoading) onLoginClick(email, password)
                    },
                ),
                singleLine = true,
                enabled = !uiState.isLoading,
            ...
            val registerText = buildAnnotatedString {
                ...
                withStyle(
                    ...
                    append(stringResource(R.string.login_link_register))
                }
            }
            Box(
                modifier = Modifier.fillMaxWidth(),
